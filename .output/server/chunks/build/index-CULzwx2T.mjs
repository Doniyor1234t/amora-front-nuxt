...
import { u as useStrapi, a as useStrapiQuery, m as mapProductsResponse, b as mapProductEntity } from './catalogMappers-QA2PDDPy.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="max-md:grid max-md:grid-cols-2 md:hidden"><!--[-->`);
      ...
      _push(`</div></div></div></div></section><section class="slide-section"><div class="slide-section__inner max-md:p-0!"><div class="contact-layout"><div class="contact-map max-md:order-1">`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
...
//# sourceMappingURL=index-CULzwx2T.mjs.map
