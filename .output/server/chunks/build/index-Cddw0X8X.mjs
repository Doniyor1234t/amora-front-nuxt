...
import { defineComponent, ref, computed, watch, watchEffect, mergeProps, unref, withCtx, createTextVNode, createBlock, openBlock, createVNode, Fragment, renderList, toDisplayString, useSSRContext } from 'vue';
...
import { u as useRouter, c as useRoute } from './server.mjs';
import '@iconify/vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const normalizeSizeOptionValue = (value) => typeof value === "string" ? value.trim() : "";
    ...
    const { data: sizeOptionsResponse } = useStrapiQuery(
      ...
      }),
      {
        select: (response) => response.data.map((entity) => {
          ...
          const normalizedLabel = normalizeSizeOptionValue(attributes.label) || normalizeSizeOptionValue(attributes.title);
    ...
    const syncCategoryFromRoute = () => {
      ...
      const normalizedCategory = Array.isArray(categoryQuery) ? categoryQuery[0] : categoryQuery;
      const nextValue = typeof normalizedCategory === "string" ? normalizedCategory : "";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pt-[72px]" }, _attrs))}><div class="container mb-[32px] mt-[48px]"><h2 class="text-[#0F0F0F] text-[52px] max-sm:text-[32px]"> Каталог </h2><div class="mt-[40px] max-lg:mt-[20px] flex flex-col gap-[32px] lg:flex-row"><aside class="hidden lg:block w-[260px] xl:w-[300px] shrink-0"><div class="sticky top-[120px] flex flex-col gap-10"><div><p class="text-xs tracking-[0.16em] uppercase text-[#7D7D7D]"> Категории </p><div class="mt-5 space-y-4">`);
      ...
      _push(`</div></div></div></aside><div class="flex-1"><div class="hidden md:flex items-center justify-between gap-6"><div class="flex flex-wrap gap-4"><div class="relative"><button type="button" class="flex items-center gap-2 border border-[#DADADA] px-7 py-3 text-xs tracking-[0.16em] uppercase text-[#0F0F0F]">${ssrInterpolate(activeSizeLabel.value)} <svg width="20" height="11" viewBox="0 0 20 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([sizeDropdownOpen.value ? "rotate-180" : "", "transition-transform"])}"><path d="M20 0.5C15.1724 0.499996 10 4.90678 10 10.5C10 4.90678 4.82759 0.499996 0 0.499999" stroke="#0F0F0F"></path></svg></button>`);
      if (sizeDropdownOpen.value) {
        _push(`<div class="absolute left-0 z-20 mt-2 w-56 border border-[#E6E6E6] bg-white py-2 shadow-2xl"><!--[-->`);
        ssrRenderList(sizeDropdownOptions.value, (option) => {
          _push(`<button type="button" class="${ssrRenderClass([[
      ...
      _push(`</div><div class="relative"><button type="button" class="flex items-center gap-2 border border-[#DADADA] px-7 py-3 text-xs tracking-[0.16em] uppercase text-[#0F0F0F]">${ssrInterpolate(activeSortLabel.value)} <svg width="20" height="11" viewBox="0 0 20 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([sortDropdownOpen.value ? "rotate-180" : "", "transition-transform"])}"><path d="M20 0.5C15.1724 0.499996 10 4.90678 10 10.5C10 4.90678 4.82759 0.499996 0 0.499999" stroke="#0F0F0F"></path></svg></button>`);
      if (sortDropdownOpen.value) {
        _push(`<div class="absolute left-0 z-20 mt-2 w-60 border border-[#E6E6E6] bg-white py-2 shadow-2xl"><!--[-->`);
      ...
      if (showSkeletonGrid.value) {
        ...
        ssrRenderList(skeletonItems.value, (index) => {
          _push(`<div class="w-full flex flex-col gap-4"><div class="bg-[#F5F5F5] overflow-hidden h-[360px] animate-pulse"></div><div class="px-[24px] py-[20px] space-y-3"><div class="h-3 w-3/4 bg-[#E2E2E2] animate-pulse"></div><div class="h-3 w-1/2 bg-[#E2E2E2] animate-pulse"></div></div></div>`);
        });
        _push(`<!--]--></div>`);
        ...
        _push(`<div class="relative"><div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-12"><!--[-->`);
        ...
        if (isUpdatingPage.value) {
          ...
          ssrRenderList(skeletonItems.value, (index) => {
            _push(`<div class="hidden sm:flex flex-col gap-4 animate-pulse"><div class="bg-[#F5F5F5] h-[320px]"></div><div class="px-[24px] py-[12px] space-y-2"><div class="h-3 w-2/3 bg-[#E2E2E2]"></div><div class="h-3 w-1/2 bg-[#E2E2E2]"></div></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
      ...
      _push(ssrRenderComponent(unref(script$1), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(sizeFilterOptions.value, (size) => {
                ...
                createVNode("div", { class: "flex flex-col gap-[24px]" }, [
                  ...
                  createVNode("div", null, [
                    ...
                    createVNode("div", { class: "mt-4 flex flex-wrap gap-3" }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(sizeFilterOptions.value, (size) => {
                        return openBlock(), createBlock("div", {
...
//# sourceMappingURL=index-Cddw0X8X.mjs.map
