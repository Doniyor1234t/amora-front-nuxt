...
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createTextVNode, createBlock, openBlock, createVNode, isRef, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from 'vue/server-renderer';
import { p as publicAssetsURL } from '../nitro/nitro.mjs';
import { u as useSwiper } from './useSwiper.client-BP2iX_YN.mjs';
import { Y as YandexMap } from './YandexMap-C3Fj2wwI.mjs';
...
const _imports_0 = publicAssetsURL("/images/main-collection-1.png");
const _imports_1 = publicAssetsURL("/images/main-collection-2.png");
const _sfc_main$1 = {
  __name: "SharedBanner",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { items: unref(banners) }, null, _parent));
      _push(`</div></section><section class="slide-section"><div class="slide-section__inner">`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<div class="products-grid md:hidden"><!--[-->`);
...
//# sourceMappingURL=index-CkmhA-KD.mjs.map
