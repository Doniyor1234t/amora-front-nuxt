...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pt-[72px]" }, _attrs))}><div class="container mb-[32px] mt-[48px]"><h2 class="text-[#0F0F0F] text-[52px] font-[masvol] max-sm:text-[34px]"> Каталог </h2><div class="mt-[40px] flex flex-col gap-[32px] lg:flex-row"><aside class="hidden lg:block w-[260px] xl:w-[300px] shrink-0"><div class="sticky top-[120px] flex flex-col gap-10"><div><p class="text-xs tracking-[0.16em] uppercase text-[#7D7D7D]"> Категории </p><div class="mt-5 space-y-4">`);
      ...
      if (showSkeletonGrid.value) {
        ...
        ssrRenderList(products.value, (product) => {
          _push(`<div class="w-full flex flex-col justify-between cursor-pointer transition-transform hover:-translate-y-1"><div class="relative overflow-hidden h-[360px] flex items-center justify-center"><button type="button" class="absolute right-5 top-5 flex h-10 w-10 items-center justify-center transition hover:scale-105">`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "app-icon:heart-outlined",
            mode: "svg",
            class: isFavorite(product.id) ? "blackIcon" : null,
            color: isFavorite(product.id) ? "#000" : void 0,
            size: "20"
          }, null, _parent));
...
//# sourceMappingURL=index-CacsKSpc.mjs.map
