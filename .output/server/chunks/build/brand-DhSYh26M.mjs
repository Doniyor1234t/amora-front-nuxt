...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-[#F4F1EC] pb-20 pt-[72px] text-[#1F1B16]" }, _attrs))}><div class="w-full"><img${ssrRenderAttr("src", _imports_0)} alt="" class="w-full object-cover h-[560px]"></div><div class="container py-[52px] max-sm:py-[20px]"><div class="grid grid-cols-2 max-sm:grid-cols-1 max-sm:gap-[20px]"><div><h2 class="text-[#0F0F0F] text-[52px] font-[masvol] max-sm:text-[32px]"> AMORA - бренд, рождённый эстетикой женственности </h2></div><div><p class="text-[#3D3D3D] text-[14px] max-sm:text-[12px]"> AMORA — это премиальный fashion-бренд и ателье, основанное на идее мягкой женственности, натуральных тканей и утончённых силуэтов. Каждое изделие создаётся вручную нашими мастерами — от первых эскизов до финальной драпировки, сохраняя couture-подход и европейское качество. </p><p class="text-[#3D3D3D] text-[14px] mt-[20px]"> Мы создаём одежду, в которой сочетаются ручная работа, сложный крой и современная элегантность </p>`);
      ...
      _push(`<!--]--></div></div><section class="container py-[260px] mx-auto mt-20 px-4"><div class="w-[700px] flex flex-col gap-2 items-center content-center mx-auto text-center px-[48px] py-[56px] text-center max-md:px-[32px]">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ri:double-quotes-l",
        size: "48",
        class: "text-[#C4BBAF]"
      }, null, _parent));
      _push(`<p class="text-[42px] font-[masvol] leading-snug text-[#6D6A65] max-md:text-[30px]"> “Наша миссия — раскрывать внутреннюю красоту женщины через внешний облик, даря ей уверенность в каждом движении.” </p></div></section><section class="container mx-auto mt-20 px-4"><h3 class="text-center font-[masvol] text-[52px] text-[#1F1B16]">Атмосфера творчества</h3><div class="mt-12 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]"><div class="overflow-hidden bg-white shadow-[0_25px_90px_rgba(40,34,28,0.1)]"><img${ssrRenderAttr("src", _imports_1)} alt="Sketch large" class="h-full w-full object-cover"></div><div class="grid gap-6 sm:grid-cols-2"><!--[-->`);
      ssrRenderList(galleryImages, (image, index) => {
        _push(`<div class="overflow-hidden bg-white shadow-[0_20px_70px_rgba(40,34,28,0.08)]"><img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", `Атмосфера ${index + 1}`)} class="h-full w-full object-cover"></div>`);
      });
      _push(`<!--]--></div></div></section><section class="container mx-auto mt-24 px-4"><div class="grid gap-12 rounded-[60px] bg-white px-[48px] py-[64px] shadow-[0_35px_110px_rgba(33,29,24,0.12)] max-lg:px-[32px]"><div class="flex items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]"><div class="rounded-[36px] min-h-[500px] bg-[#F4F1EC]"><img${ssrRenderAttr("src", _imports_2)} alt="Founder portrait" class="h-full w-full rounded-[28px] object-cover"></div><div class="min-w-[752px]"><p class="text-xs uppercase tracking-[0.5em] text-[#B0A79D]">• основательница бренда •</p><h3 class="mt-4 font-[masvol] text-[50px] text-[#1F1B16]">${ssrInterpolate(founder.name)}</h3><div class="mt-6 space-y-4 text-sm leading-relaxed text-[#6F6A63]"><!--[-->`);
...
//# sourceMappingURL=brand-DhSYh26M.mjs.map
