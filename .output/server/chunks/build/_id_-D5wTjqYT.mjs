...
import { A as AppCallBackModal } from './AppCallBackModal-CmRClWj0.mjs';
import { e as createError, z as getRequestURL } from '../nitro/nitro.mjs';
import { u as useStrapi, a as useStrapiQuery, b as mapProductFromResponse } from './catalogMappers-uVoungiu.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="bg-[#FBFAF9]" data-v-bcf5559d><div class="flex min-h-[calc(100vh-72px)] max-md:flex-col max-lg:flex md:basis-[50%]" data-v-bcf5559d><div class="flex overflow-y-auto no-scrollbar flex-col bg-[#fff] flex-1" data-v-bcf5559d><div class="md:flex max-md:hidden overflow-y-auto no-scrollbar flex-col h-full" data-v-bcf5559d><!--[-->`);
      ssrRenderList(productImages.value, (value, index) => {
        _push(`<div class="relative min-h-[calc(100vh)] flex items-center justify-center" data-v-bcf5559d><img${ssrRenderAttr("src", value)} alt="Product image" class="h-full w-full object-cover object-top max-xl:object-cover" data-v-bcf5559d></div>`);
      });
      _push(`<!--]--></div><div class="md:hidden w-full h-full px-4 py-6" data-v-bcf5559d>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</div></div><div class="h-[calc(100vh-72px)] overflow-y-auto px-[72px] py-[80px] bg-[#FBFAF9] max-xl:px-12 max-lg:px-10 max-md:px-8 max-sm:px-4 max-sm:py-8 max-md:h-auto max-md:relative md:sticky md:top-[72px] md:basis-[50%]" data-v-bcf5559d>`);
      if (unref(isProductLoading)) {
        _push(`<div class="text-center text-[#0F0F0F] py-10" data-v-bcf5559d> Загрузка информации о товаре... </div>`);
      } else if (unref(isProductError) || !product.value) {
        _push(`<div class="text-center text-[#C16371] py-10" data-v-bcf5559d> Не удалось загрузить информацию о товаре. Попробуйте позже. </div>`);
      } else {
        _push(`<div class="flex flex-col gap-8 w-full max-w-[620px] text-[#0F0F0F]" data-v-bcf5559d><div class="flex flex-col gap-3" data-v-bcf5559d><span class="text-xs text-[#C16371] flex items-center gap-3" data-v-bcf5559d>${ssrInterpolate(collectionName.value)}</span><h1 class="text-[72px] font-[masvol] leading-[1] max-lg:text-[56px] max-md:text-[46px] max-sm:text-[36px]" data-v-bcf5559d>${ssrInterpolate(product.value.name)}</h1><p class="font-semibold text-[20px] max-sm:text-[20px]" data-v-bcf5559d>${ssrInterpolate(formatPrice(product.value.price, product.value.currency ? product.value.currency : void 0))}</p></div><div class="flex flex-col gap-4" data-v-bcf5559d><div class="flex items-center justify-between" data-v-bcf5559d><p class="font-bold uppercase text-[14px] text-[#0F0F0F]" data-v-bcf5559d>Размер</p>`);
        if (selectedSize.value) {
          _push(`<span class="text-xs uppercase text-[#C16371]" data-v-bcf5559d>${ssrInterpolate(selectedSize.value ? selectedSize.value.toUpperCase() : "")}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (hasSizeOptions.value) {
          _push(`<div class="flex flex-wrap gap-3" data-v-bcf5559d><!--[-->`);
          ssrRenderList(sizeOptions.value, (option) => {
            ...
            ], "px-3 h-[22px] rounded-full border text-[14px] uppercase transition-all"])}" data-v-bcf5559d>${ssrInterpolate(option.value.toUpperCase())}</button>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<p class="text-[15px] uppercase tracking-[0.2em] text-[#CDC6BF]" data-v-bcf5559d>${ssrInterpolate(availableSizesText.value)}</p>`);
        }
        _push(`</div><div class="flex gap-5" data-v-bcf5559d>`);
        ...
        _push(`<button type="button" class="h-12 w-12 rounded-full border border-[#E4E0DA] flex items-center justify-center hover:bg-[#F7F5F0] transition-colors"${ssrRenderAttr("aria-pressed", isFavorite.value)} data-v-bcf5559d>`);
        ...
        _push(`</button></div><div class="flex flex-col border-[#E8E2DC] divide-y divide-[#E8E2DC]" data-v-bcf5559d><div class="py-6" data-v-bcf5559d><button type="button" class="w-full flex items-center justify-between" data-v-bcf5559d><p class="text-[14px] leading-5 uppercase font-bold text-[#0F0F0F]" data-v-bcf5559d>Состав</p>`);
        _push(ssrRenderComponent(_component_Icon, {
        ...
        if (detailsSections.value.composition) {
          _push(`<div class="mt-4" data-v-bcf5559d><ul class="flex flex-col gap-1" data-v-bcf5559d><!--[-->`);
          ssrRenderList(composition.value, (item, index) => {
            _push(`<li class="font-300 uppercase text-[#3D3D3D] text-[14px]" data-v-bcf5559d>${ssrInterpolate(item)}</li>`);
          });
          _push(`<!--]--></ul></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="py-6" data-v-bcf5559d><button type="button" class="w-full flex items-center justify-between" data-v-bcf5559d><p class="text-[14px] uppercase tracking-[0.05em] font-semibold text-[#0F0F0F]" data-v-bcf5559d>Уход</p>`);
        _push(ssrRenderComponent(_component_Icon, {
        ...
        if (detailsSections.value.care) {
          _push(`<div class="mt-4" data-v-bcf5559d><ul class="flex font-300 flex-col gap-1 uppercase text-[#3D3D3D] text-[14px]" data-v-bcf5559d><!--[-->`);
          ssrRenderList(careInstructions.value, (item, index) => {
            _push(`<li data-v-bcf5559d>${ssrInterpolate(item)}</li>`);
          });
          _push(`<!--]--></ul></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="py-6" data-v-bcf5559d><button type="button" class="w-full flex items-center justify-between" data-v-bcf5559d><p class="text-[14px] uppercase tracking-[0.05em] font-semibold text-[#0F0F0F]" data-v-bcf5559d>Описание</p>`);
        _push(ssrRenderComponent(_component_Icon, {
        ...
        if (detailsSections.value.description) {
          _push(`<div class="mt-4" data-v-bcf5559d><p class="text-[15px] leading-relaxed tracking-[0.05em] text-[#3D3D3D]" data-v-bcf5559d>${ssrInterpolate(descriptionText.value)}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
      ...
      if (hasComplementaryProducts.value) {
        _push(`<div class="complementary-products-section px-4 py-16 max-sm:py-10 bg-[#FBFAF9]" data-v-bcf5559d><div class="complementary-products container mx-auto" data-v-bcf5559d><div class="complementary-products__header flex items-center justify-between mb-10 max-sm:mb-2.5 max-sm:flex-col max-sm:items-start max-sm:gap-6" data-v-bcf5559d><h2 class="text-[44px] font-[masvol] text-[#0F0F0F] max-sm:text-[32px]" data-v-bcf5559d> Дополните образ </h2><div class="max-md:hidden complementary-products__controls flex gap-4" data-v-bcf5559d><button type="button" class="complementary-products__control" data-v-bcf5559d>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "ph:arrow-left",
          size: "16"
        }, null, _parent));
        _push(`</button><button type="button" class="complementary-products__control" data-v-bcf5559d>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "ph:arrow-right",
          size: "16"
        }, null, _parent));
        ...
        _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
        _push(`<div class="md:hidden flex flex-wrap gap-x-2" data-v-bcf5559d><!--[-->`);
        ssrRenderList(complementaryProductCards.value, (item) => {
          _push(`<div class="mb-8 shrink-0 grow-0 basis-[48%]" data-v-bcf5559d><div class="complementary-card" data-v-bcf5559d><div class="complementary-card__image" data-v-bcf5559d><img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.name)} data-v-bcf5559d><button type="button" class="complementary-card__favorite"${ssrRenderAttr("aria-pressed", isProductLiked(item.id))} data-v-bcf5559d>`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "app-icon:heart-outlined",
            mode: "svg",
          ...
          _push(`</button></div><div class="complementary-card__info" data-v-bcf5559d><p class="complementary-card__title" data-v-bcf5559d>${ssrInterpolate(item.name)}</p><span class="complementary-card__price" data-v-bcf5559d>${ssrInterpolate(item.price)}</span></div></div></div>`);
        });
        _push(`<!--]--></div></div></div>`);
      } else {
        _push(`<!---->`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bcf5559d"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-D5wTjqYT.mjs.map
