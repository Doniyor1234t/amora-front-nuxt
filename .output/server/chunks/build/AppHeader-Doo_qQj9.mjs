...
import { defineComponent, ref, computed, watch, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, createBlock, openBlock, createCommentVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-8a06c74c><div class="container flex h-[72px] items-center max-sm:h-[60px]" data-v-8a06c74c>`);
      _push(ssrRenderComponent(unref(script), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="max-sm:w-full max-sm:flex max-sm:justify-between" data-v-8a06c74c${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_Button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<p class="text-sm md:!hidden" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-8a06c74c${_scopeId2}>${ssrInterpolate(favoriteCount.value)}</p>`);
                } else {
                  return [
                    createVNode(_component_Icon, {
                      name: "app-icon:heart-outlined",
                    ...
                    }, toDisplayString(favoriteCount.value), 5)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</div><div class="flex flex-col gap-2 w-full h-full justify-center gap-9 max-sm:gap-4 max-sm:justify-start" data-v-8a06c74c${_scopeId}>`);
      ...
      _push(`<div class="flex gap-2" data-v-8a06c74c>`);
      _push(ssrRenderComponent(_component_Button, {
        variant: "text",
        severity: "secondary",
      ...
      _push(`<div class="sm:hidden relative flex items-center" data-v-8a06c74c>`);
      _push(ssrRenderComponent(_component_Button, {
        variant: "text",
        severity: "secondary",
        onClick: handleFavoritesClick
      ...
      if (favoriteCount.value) {
        _push(`<span class="favorites-badge" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-8a06c74c>${ssrInterpolate(favoriteCount.value)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      ...
      _push(ssrRenderComponent(_component_Button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (favoriteCount.value) {
              _push2(`<span class="favorites-badge" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-8a06c74c${_scopeId}>${ssrInterpolate(favoriteCount.value)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const AppHeader = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-8a06c74c"]]), { __name: "LayoutAppHeader" });

export { AppHeader as A };
//# sourceMappingURL=AppHeader-Doo_qQj9.mjs.map
