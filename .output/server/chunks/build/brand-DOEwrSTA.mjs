...
import { _ as _imports_3, a as _imports_2$1 } from './virtual_public-ZWLZJ-qO.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-[#F4F1EC] pb-20 pt-[72px] text-[#1F1B16]" }, _attrs))}><div class="w-full"><img${ssrRenderAttr("src", _imports_3)} alt="" class="w-full object-cover h-[560px]"></div><div class="container py-[52px] max-sm:py-[20px]"><div class="grid grid-cols-2 max-sm:grid-cols-1 max-sm:gap-[20px]"><div><h2 class="text-[#0F0F0F] text-[52px] font-[masvol] max-sm:text-[32px]"> AMORA - бренд, рождённый эстетикой женственности </h2></div><div><p class="text-[#3D3D3D] text-[14px] max-sm:text-[12px]"> AMORA — это премиальный fashion-бренд и ателье, основанное на идее мягкой женственности, натуральных тканей и утончённых силуэтов. Каждое изделие создаётся вручную нашими мастерами — от первых эскизов до финальной драпировки, сохраняя couture-подход и европейское качество. </p><p class="text-[#3D3D3D] text-[14px] mt-[20px]"> Мы создаём одежду, в которой сочетаются ручная работа, сложный крой и современная элегантность </p>`);
...
//# sourceMappingURL=brand-DOEwrSTA.mjs.map
