...
import { defineComponent, ref, withCtx, createVNode, createBlock, openBlock, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isSubmitted.value) {
        _push(`<div class="w-[446px]"><div><h2 class="text-[52px] font-[masvol] text-center"> Открытие нового пространства AMORA </h2><p class="text-[14px] text-center mt-[16px] uppercase"> Пройдите регистрацию на мини-лекцию со стилистом в ателье Amora </p></div><form class="flex flex-col gap-[20px] mt-[32px]">`);
        ...
        _push(ssrRenderComponent(_component_Button, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>ОТПРАВИТЬ</span><svg width="36" height="20" viewBox="0 0 36 20" fill="none" xmlns="http://www.w3.org/2000/svg"${_scopeId}><path d="M0 10L36 10" stroke="white"${_scopeId}></path><path d="M26 0C26 4.82759 30.4068 10 36 10C30.4068 10 26 15.1724 26 20" stroke="white"${_scopeId}></path></svg>`);
            } else {
              return [
...
//# sourceMappingURL=webform-Q-bSYmK1.mjs.map
