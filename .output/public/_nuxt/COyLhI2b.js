import{s as c}from"./hoxfqk71.js";import{s as d,a as m}from"./CRXM6pyQ.js";import{s as g}from"./DHpcbKhF.js";import{s as p}from"./D6Jdcfie.js";import{ae as u,c as a,o as i,at as t,C as f,g as b,av as o,aw as h}from"./D3Io7_SF.js";import"./DOp6rTCc.js";var w=`
    .p-inlinemessage {
        display: inline-flex;
        align-items: center;
...
`,y={root:function(e){var s=e.props,r=e.instance;return["p-inlinemessage p-component p-inlinemessage-"+s.severity,{"p-inlinemessage-icon-only":!r.$slots.default}]},icon:function(e){var s=e.props;return["p-inlinemessage-icon",s.icon]},text:"p-inlinemessage-text"},v=u.extend({name:"inlinemessage",style:w,classes:y}),x={name:"BaseInlineMessage",extends:p,props:{severity:{type:String,default:"error"},icon:{type:String,default:void 0}},style:v,provide:function(){return{$pcInlineMessage:this,$parentInstance:this}}},k={name:"InlineMessage",extends:x,inheritAttrs:!1,timeout:null,data:function(){return{visible:!0}},mounted:function(){var e=this;this.sticky||setTimeout(function(){e.visible=!1},this.life)},computed:{iconComponent:function(){return{info:m,success:c,warn:d,error:g}[this.severity]}}};function $(n,e,s,r,C,l){return i(),a("div",o({role:"alert","aria-live":"assertive","aria-atomic":"true",class:n.cx("root")},n.ptmi("root")),[t(n.$slots,"icon",{},function(){return[(i(),b(h(n.icon?"span":l.iconComponent),o({class:n.cx("icon")},n.ptm("icon")),null,16,["class"]))]}),n.$slots.default?(i(),a("div",o({key:0,class:n.cx("text")},n.ptm("text")),[t(n.$slots,"default")],16)):f("",!0)],16)}k.render=$;export{k as default};
